...
import { defaultFontFamily, colors } from '../../theme';
...
export default {
  ...
  toolbarDefaultBg: platform === 'ios' ? '#F8F8F8' : colors.white,
  ...
  // Spinner
  defaultSpinnerColor: colors.violet,
  ...
  titleFontColor: colors.warmGrey,
